...
public class DataPojokKesehatan {
    String idTopik, gambarTopik, judulTopik, kategoriTopik, DeskripsiTopik, jumlahKomen, jumlahLike, jumlahReKuy;

    public DataPojokKesehatan() {

    }

    public DataPojokKesehatan(String idTopik, String gambarTopik, String judulTopik, String kategoriTopik, String deskripsiTopik, String jumlahKomen, String jumlahLike, String jumlahReKuy) {
